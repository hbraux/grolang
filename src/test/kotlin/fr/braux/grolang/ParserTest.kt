...
class ParserTest {
  ...
  @Test
  fun testDeclaration() {
    assertEquals("lang.defval('anInt,'Int)",  read("val anInt :Int"))
    assertEquals("lang.defvar('aFloat,'Float)",  read("var aFloat :Float"))
    assertEquals("lang.defval('myBool,'Bool); lang.assign('myBool, true)",  read("val myBool = true"))
    // type inference
